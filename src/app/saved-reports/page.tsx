...
export default function SavedReportsPage() {
  ...
  useEffect(() => {
    getSavedReports().then(setReports).catch((error) => setLoadError(error instanceof Error ? error.message : "저장된 보고서를 불러오지 못했습니다.")).finally(() => setIsLoading(false));
  }, []);
  ...
  const removeReport = async (id: string) => {
    try {
      ...
      setLoadError(error instanceof Error ? error.message : "보고서를 삭제하지 못했습니다.");
    }
  };
